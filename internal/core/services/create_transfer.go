...
func NewTransferService(
	// // transferRepo domain.TransferRepository,
	// // accountRepo domain.AccountRepository,
	handler action.CreateTransferAction,
	t time.Duration,
) TransferTransaction {
...
func (t TransferTransaction) Execute(ctx context.Context, input CreateTransferInput) (CreateTransferOutput, error) {
	...
	//}
	//
	return CreateTransferOutput{}, nil
}
